    ...
    <>
      ...
      >
        <FiveDaysForecastItem
          ...
          color="black"
        />
        <FiveDaysForecastItem type="clouds" value={props.value} color="black" />
      </Grid>
      ...
      >
        <FiveDaysForecastItem type="humidity" value={props.value} color="green" />
        <FiveDaysForecastItem type="pressure" value={props.value} color="green" />
      </Grid>
    </>
  );
};
